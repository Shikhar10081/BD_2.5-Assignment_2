...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  let CopyStock = stocks.slice();
  CopyStock.sort((stock1, stock2) => sortByPricing(stock1, stock2, pricing));
  res.json({ stocks: CopyStock });
});
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  let Copygrowth = stocks.slice();
  Copygrowth.sort((stock1, stock2) => sortByGrowth(stock1, stock2, growth));
  res.json({ stocks: Copygrowth });
});
...
app.get('/stocks/filter/industry', (req, res) => {
  ...
  let StockNew = stocks.filter((stocks) => filterByIndustry(stocks, industry));
  res.json({ stocks: StockNew });
});
